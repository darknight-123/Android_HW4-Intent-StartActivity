...
import ttu.cse.hw4.placeholder.PlaceholderContent.PlaceholderItem;
import ttu.cse.hw4.databinding.FragmentItem2Binding;
...
public class MyStarRecyclerViewAdapter extends RecyclerView.Adapter<MyStarRecyclerViewAdapter.ViewHolder> {
    ...
    public MyStarRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
